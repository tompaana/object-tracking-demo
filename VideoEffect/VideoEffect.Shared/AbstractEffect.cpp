...
CAbstractEffect::CAbstractEffect() :
	m_rcDest(D2D1::RectU()),
	m_pTransformFn(NULL),
...
STDMETHODIMP CAbstractEffect::RuntimeClassInitialize()
{
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::SetProperties(ABI::Windows::Foundation::Collections::IPropertySet *pConfiguration)
{
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::GetStreamLimits(
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::GetStreamCount(
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::GetStreamIDs(
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::GetInputStreamInfo(
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::GetOutputStreamInfo(
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::GetAttributes(IMFAttributes** ppAttributes)
{
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::GetInputStreamAttributes(
	DWORD           dwInputStreamID,
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::GetOutputStreamAttributes(
	DWORD           dwOutputStreamID,
	IMFAttributes   **ppAttributes
	)
{
...
// DeleteInputStream
//-------------------------------------------------------------------
HRESULT CAbstractEffect::DeleteInputStream(DWORD dwStreamID)
{
...
// AddInputStreams
//-------------------------------------------------------------------
HRESULT CAbstractEffect::AddInputStreams(
	DWORD   cStreams,
	DWORD   *adwStreamIDs
	)
{
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::GetInputAvailableType(
	DWORD           dwInputStreamID,
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::GetOutputAvailableType(
	DWORD           dwOutputStreamID,
	DWORD           dwTypeIndex, // 0-based
	IMFMediaType    **ppType
	)
...
// SetInputType
//-------------------------------------------------------------------
HRESULT CAbstractEffect::SetInputType(
	DWORD           dwInputStreamID,
...
// SetOutputType
//-------------------------------------------------------------------
HRESULT CAbstractEffect::SetOutputType(
	DWORD           dwOutputStreamID,
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::GetInputCurrentType(
	DWORD           dwInputStreamID,
	IMFMediaType    **ppType
	)
{
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::GetOutputCurrentType(
	DWORD           dwOutputStreamID,
	IMFMediaType    **ppType
	)
{
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::GetInputStatus(
	DWORD           dwInputStreamID,
	DWORD           *pdwFlags
	)
{
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::GetOutputStatus(DWORD *pdwFlags)
{
	if (pdwFlags == NULL)
	{
		return E_POINTER;
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::SetOutputBounds(
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::ProcessEvent(
	DWORD              dwInputStreamID,
...
// ProcessMessage
//-------------------------------------------------------------------
HRESULT CAbstractEffect::ProcessMessage(
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::ProcessInput(
	DWORD               dwInputStreamID,
	IMFSample           *pSample,
	DWORD               dwFlags
	)
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::ProcessOutput(
	DWORD                   dwFlags,
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::OnGetPartialType(DWORD dwTypeIndex, IMFMediaType **ppmt)
{
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::OnCheckInputType(IMFMediaType *pmt)
{
	assert(pmt != NULL);
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::OnCheckOutputType(IMFMediaType *pmt)
{
	assert(pmt != NULL);
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::OnCheckMediaType(IMFMediaType *pmt)
{
...
//-------------------------------------------------------------------
void CAbstractEffect::OnSetInputType(IMFMediaType *pmt)
{
...
//-------------------------------------------------------------------
void CAbstractEffect::OnSetOutputType(IMFMediaType *pmt)
{
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::BeginStreaming()
{
...
//-------------------------------------------------------------------
HRESULT CAbstractEffect::EndStreaming()
{
    m_bStreamingInitialized = false;
	return S_OK;
}
...
// Flush the MFT.
//-------------------------------------------------------------------
HRESULT CAbstractEffect::OnFlush()
{
...
// input type is set.
//-------------------------------------------------------------------
HRESULT CAbstractEffect::UpdateFormatInfo()
{
	HRESULT hr = S_OK;
	...
	if (m_pInputType != NULL)
	{
		...
		{
			throw "UYVY format not supported";
		}
		else if (subtype == MFVideoFormat_NV12)
		{
            m_pTransformFn = ChromaFilterTransformImageNV12;
		}
		else
		{
			hr = E_UNEXPECTED;
